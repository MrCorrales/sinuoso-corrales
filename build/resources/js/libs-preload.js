  ...
  _createClass(MrInteraction, [{
    ...
    value: function _down() {
      ...
      this.container.addEventListener(Basics.downEvent, function (e) {
        _this6.positions.click = {
          x: e.clientX,
          y: e.clientY
        };

        if (_this6.options.drag) {
          _this6._idTimer = setTimeout(function () {
            _this6.isDragging = true;
            if (_this6.options.onDragStart) _this6.options.onDragStart();
          }, _this6.options.dragCheckTime);
        }

        if (_this6.options.onMouseDown) {
          _this6.options.onMouseDown();
        }
      });
    }
  }, {
    ...
    value: function _up() {
      ...
      this.container.addEventListener(Basics.upEvent, function (e) {
        ...
        if (_this7.isDragging) {
          ...
          if (_this7.options.onDragEnd) _this7.options.onDragEnd();
          setTimeout(function () {
            _this7.isDragged = false;
          }, 100);
        }

        if (_this7.options.onMouseUp) {
          _this7.options.onMouseUp();
        }
      });
    }
  }, {
...
var Functions = {
  ...
  doMrCorrales: function doMrCorrales() {
    ...
    console.log('');
    console.log('Object Sans Bold');
    console.log('⟶ https://pangrampangram.com/');
    console.log('');
...
var Maths = {
  ...
  difference: function difference(__actual, __to) {
    var __mult = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;

    var __isFloat = arguments.length > 3 ? arguments[3] : undefined;

    if (__isFloat) {
      return (__to - __actual) * __mult;
    } else {
      return Math.floor(__to - __actual) * __mult;
    }
  },
...
var FormValidator = /*#__PURE__*/function () {
  ...
  _createClass(FormValidator, [{
    ...
    value: function setupFocus(__item) {
      ...
      __item.addEventListener('focus', function (event) {
        __item.classList.remove("error");

        __item.parentNode.classList.remove("error");
      });
  ...
  _createClass(VScroll, [{
    ...
    value: function loop() {
      ...
      if (this.target !== this.position || __force) {
        ...
        if (this.speed > 0) {
          this.speed = Math.min(this.speed, (this.p0 - this.position) / 10);
...
var VScroll_Item = /*#__PURE__*/function () {
  ...
  _createClass(VScroll_Item, [{
    ...
    key: "progressInvertZero",
    get: function get() {
      return Maths.precission(Maths.normalize(this._p1 - this._scroller[this._scroller._measure], this._p0 + this._scroller[this._scroller._measure], this.positionAxis), 3);
    }
  }, {
    key: "realX",
    get: function get() {
    ...
    value: function update() {
      ...
      if (this.isInViewport) {
        ...
        this._needUpdate = false; //this.item.style.visibility = "hidden";
    ...
    value: function resizeLimits(__h) {
      ...
      if (!this._scroller.isNative) {
        this.draw(); //this.item.style[CSS.transform] = CSS.translate3D(this._x, this._y, this._z);
      }
...
var VScrollInfinity = /*#__PURE__*/function () {
  //
  // CONSTRUCTOR
  //
  function VScrollInfinity(__container) {
    var __element = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;

    var __onChange = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;

    var __type = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'MANUAL';

    _classCallCheck(this, VScrollInfinity);

    _defineProperty(this, "type", null);

    _defineProperty(this, "maxV", 4000);

    _defineProperty(this, "res", 0.09);

    _defineProperty(this, "vel", 0);

    _defineProperty(this, "mainVel", 0);

    _defineProperty(this, "target", 0);

    _defineProperty(this, "scrollPosition", 0);

    _defineProperty(this, "scrollSize", 0);

    _defineProperty(this, "y", 0);

    _defineProperty(this, "y0", 0);

    _defineProperty(this, "y1", 0);

    _defineProperty(this, "nItems", 0);
    ...
    _defineProperty(this, "_separacion", 0);

    _defineProperty(this, "multiplicator", Basics.isTouch ? 2 : 1);

    _defineProperty(this, "_items", []);

    _defineProperty(this, "_itemsCheck", []);

    _defineProperty(this, "_container", null);

    _defineProperty(this, "_actual", null);

    _defineProperty(this, "_zero", null);
  ...
  _createClass(VScrollInfinity, [{
    ...
    key: "_check",
    value: function _check(e) {
      var d = Math.abs(e.deltaY) > Math.abs(e.deltaX) ? e.deltaY * this.multiplicator : e.deltaX * this.multiplicator;
      Scroll.isScrolling = true;
    ...
    value: function addAll() {
      ...
      for (var i = 0, j = _items.length; i < j; i++) {
        var _item = new VScrollInfinityItem(_items[i], this.nItems, this);
    ...
    value: function setScrollbar(__scrollbar) {
      ...
      this.scrollbar.onChange = function (__p) {
        _this["goto"](Maths.lerp(_this.y0, -_this.y1, __p));
      };
    }
  }, {
    key: "resetPositions",
    ...
    key: "goto",
    value: function goto(__n) {
      var __t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 3;

      var __e = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : Expo.easeOut;

      this.mainVel = 0;
      this.vel = 0;
      TweenLite.to(this, __t, {
        x: __n,
        ease: __e
      });
    }
    ...
    value: function loop() {
      if (this._enabled) {
        ...
        if (this.vel < 0) {
          ...
          var ant = this.first;
          var act = this.first + 1;

          for (var i = 1; i < this.nItems; i++) {
          ...
          for (var _i = 0; _i < this.nItems; _i++) {
            this._itemsCheck[_i].checkPosition(this._separacion);
          }
        } else if (this.vel > 0) {
          this._items[this.last].y = this._items[this.last].y + this.vel;
          var _ant = this.last;

          var _act = this.last - 1;

          for (var _i2 = 1; _i2 < this.nItems; _i2++) {
            if (_ant < 0) _ant = this.nItems - 1;
            if (_act < 0) _act = this.nItems - 1;
            this._items[_act].y = this._items[_ant].y - this._items[_act].height - this._separacion;
            _ant--;
            _act--;
          }

          for (var _i3 = 0; _i3 < this.nItems; _i3++) {
            this._itemsCheck[_i3].checkPositionInv(this._separacion);
          }
        }

        if (this._enabled && !Basics.isMobile && this.scrollbar) {
          this.calcProgress();
          this.scrollbar.update(this.progress);
        }
      } else {
    ...
    value: function calcProgress() {
      ...
      if (this.scrollPosition > this.scrollSize) this.scrollPosition = this.scrollPosition - this.scrollSize;else if (this.scrollPosition < 0) this.scrollPosition = this.scrollSize - this.scrollPosition;
    ...
    value: function resize() {
      ...
      for (var _i4 = 1; _i4 < this.nItems; _i4++) {
        if (ant === this.nItems) ant = 0;
        if (act === this.nItems) act = 0;
        this._items[act].y = this._items[ant].y + this._items[ant].height + this._separacion;
        ant++;
      ...
      for (var _i5 = 0; _i5 < this.nItems; _i5++) {
        this._itemsCheck[_i5].checkPosition(this._separacion);
      }
    }
  }, {
    key: "hide",
    value: function hide() {
      this.enabled = false;
      if (this._bar) TweenLite.to(this._bar, 1, {
        scaleX: 0
      });
    }
  }, {
  ...
  return VScrollInfinity;
}();

var VScrollInfinityItem = /*#__PURE__*/function () {
  function VScrollInfinityItem(__link, __index, __scroller) {
    _classCallCheck(this, VScrollInfinityItem);

    _defineProperty(this, "_item", void 0);

    _defineProperty(this, "index", void 0);

    _defineProperty(this, "itemAnt", void 0);

    _defineProperty(this, "itemSig", void 0);
    ...
    _defineProperty(this, "_y0", void 0);

    _defineProperty(this, "_y1", void 0);

    _defineProperty(this, "_scroller", void 0);

    _defineProperty(this, "_needUpdate", false);
    ...
    _defineProperty(this, "onLoop", null);
  ...
  _createClass(VScrollInfinityItem, [{
    key: "isInViewport",
    get: function get() {
    ...
    key: "setPositions",
    value: function setPositions(__x, __y) {
    ...
    value: function getInsiders() {
      ...
      for (var i = 0, j = _items.length; i < j; i++) {
        var item = new VScroll_Item_Sticky(_items[i]);
        this._nInsiders = this._insiders.push(item);
      }
      /* SCALERS */
      ...
      for (var _i6 = 0, _j = _items.length; _i6 < _j; _i6++) {
        var _item2 = new VScroll_Item_Scale(_items[_i6]);
      ...
      for (var _i7 = 0, _j2 = _items.length; _i7 < _j2; _i7++) {
        var _item3 = new VScroll_Item_Displace(_items[_i7]);
      ...
      for (var _i8 = 0, _j3 = _items.length; _i8 < _j3; _i8++) {
        var _item4 = new VScroll_Item_Insider(_items[_i8]);
    ...
    value: function checkPosition() {
      var __sep = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
    ...
    value: function checkPositionInv() {
      var __sep = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
...
var VScrollHInfinity = /*#__PURE__*/function () {
  //
  // CONSTRUCTOR
  //
  function VScrollHInfinity(__container, options) {
    var __onChange = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;

    _classCallCheck(this, VScrollHInfinity);
    ...
    _defineProperty(this, "autoDirection", -1);
    ...
    _defineProperty(this, "_aligning", false);
  ...
  _createClass(VScrollHInfinity, [{
    ...
    value: function addAll() {
      ...
      for (var i = 0, j = _items.length; i < j; i++) {
        var _class = Array.isArray(this.options.itemClass) ? this._getClass(_items[i]) : this.options.itemClass;
    ...
    value: function setScrollbar(__scrollbar) {
      ...
      this.scrollbar.onChange = function (__p) {
        var m = Math.max(1, Math.floor(_this.x / (-_this.p1 - Metrics.WIDTH)));

        _this["goto"](Maths.lerp(_this.p0, -_this.p1, __p) * m);
      };
    }
  }, {
    key: "resetPositions",
    ...
    value: function loop() {
      if (this._enabled) {
        ...
        this.vel = Maths.precission((this.target - this.x) * this.res, 2); //this.vel = Math.max(Math.abs(this.vel), this.options.minVelocity);
        ...
        if (this.vel < 0) {
          ...
          for (var _i = 0; _i < this.total_items; _i++) {
            this._itemsCheck[_i].checkPosition(this.options.gap);
          }
        } else if (this.vel > 0) {
          ...
          for (var _i2 = 1; _i2 < this.total_items; _i2++) {
            if (_ant < 0) _ant = this.total_items - 1;
            if (_act < 0) _act = this.total_items - 1;
            this._items[_act].x = this._items[_ant].x - this._items[_act].width - this.options.gap;
            _ant--;
            _act--;
          }

          for (var _i3 = 0; _i3 < this.total_items; _i3++) {
            this._itemsCheck[_i3].checkPositionInv(this.options.gap);
          }
        }
    ...
    value: function resize() {
      ...
      for (var _i4 = 1; _i4 < this.total_items; _i4++) {
        if (ant === this.total_items) ant = 0;
        if (act === this.total_items) act = 0;
        this._items[act].x = this._items[ant].x + this._items[ant].width + this.options.gap;
        ant++;
      ...
      for (var _i5 = 0; _i5 < this.total_items; _i5++) {
        this._itemsCheck[_i5].checkPosition(this.options.gap);
      }
    }
  }, {
    key: "hide",
  ...
  return VScrollHInfinity;
}();

var VScrollHInfinityItem = /*#__PURE__*/function () {
  function VScrollHInfinityItem(__link, __index, __scroller) {
    _classCallCheck(this, VScrollHInfinityItem);
  ...
  _createClass(VScrollHInfinityItem, [{
    key: "isInViewport",
    get: function get() {
    ...
    value: function getInsiders() {
      ...
      for (var i = 0, j = _items.length; i < j; i++) {
        var item = new VScrollH_Item_Sticky(_items[i]);
        this._nInsiders = this._insiders.push(item);
      }
      /* SCALERS */
      ...
      for (var _i6 = 0, _j = _items.length; _i6 < _j; _i6++) {
        var _item2 = new VScrollH_Item_Scale(_items[_i6]);
      ...
      for (var _i7 = 0, _j2 = _items.length; _i7 < _j2; _i7++) {
        var _item3 = new VScrollH_Item_Displace(_items[_i7]);
      ...
      for (var _i8 = 0, _j3 = _items.length; _i8 < _j3; _i8++) {
        var _item4 = new VScrollH_Item_Insider(_items[_i8]);
...
var Slider = /*#__PURE__*/function () {
  function Slider(__container) {
    ...
    if (this._total <= 1 && this._controls) {
      this._controls.classList.add("__noSlides"); //BUTTON
...
var SliderInfinityScroll = /*#__PURE__*/function () {
  function SliderInfinityScroll(__container) {
    var _this = this;

    var __opt = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    _classCallCheck(this, SliderInfinityScroll);
    ...
    _defineProperty(this, "_speedMin", 0);
  ...
  _createClass(SliderInfinityScroll, [{
    key: "speedMin",
    get: function get() {
  ...
  return SliderInfinityScroll;
}();

var SliderInfinityScroll__Item = /*#__PURE__*/function (_VScrollHInfinityItem) {
  _inherits(SliderInfinityScroll__Item, _VScrollHInfinityItem);

  var _super = _createSuper(SliderInfinityScroll__Item);

  //==================================================================================================================
  //          CONSTRUCTOR
  //==================================================================================================================
  function SliderInfinityScroll__Item(__link, __index, __scroller) {
    var _this2;

    _classCallCheck(this, SliderInfinityScroll__Item);
  ...
  _createClass(SliderInfinityScroll__Item, [{
    key: "mouseOver",
    value: function mouseOver() {
      if (!this.isVoid) {
        TweenLite.to(this._figure, 0.8, {
    ...
    key: "show",
    value: function show() {
      _get(_getPrototypeOf(SliderInfinityScroll__Item.prototype), "show", this).call(this);
    }
  }, {
    key: "hide",
    value: function hide() {
      _get(_getPrototypeOf(SliderInfinityScroll__Item.prototype), "hide", this).call(this);
    }
  }, {
    key: "loop",
    value: function loop() {}
    ...
    value: function resize(__w, __h) {
      ...
      _get(_getPrototypeOf(SliderInfinityScroll__Item.prototype), "resize", this).call(this, __w, __h);
    }
  }]);

  return SliderInfinityScroll__Item;
}(VScrollHInfinityItem);;"use strict";
...
_defineProperty(_Footer, "container", C.GetBy.id("Footer"));

_defineProperty(_Footer, "y", 0);

_defineProperty(_Footer, "yOffset", 100);

_defineProperty(_Footer, "height", void 0);

_defineProperty(_Footer, "isShow", true);;"use strict";
...
var _BG = /*#__PURE__*/function () {
  function _BG() {
    _classCallCheck(this, _BG);
  }

  _createClass(_BG, null, [{
    key: "loop",
    value: function loop() {}
  }, {
    key: "changePaletteDirect",
    value: function changePaletteDirect(__color) {
      var __call = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    ...
    key: "changePalette",
    value: function changePalette(__color) {
      var __call = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;

      var __time = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;

      var __ease = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    ...
    key: "changeBG",
    value: function changeBG(__color) {
      var __isDirect = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

      var __call = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;

      var __time = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : .3;

      var __ease = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : Quad.easeOut;
...
_defineProperty(_BG, "container", document.body);

_defineProperty(_BG, "actualPalette", null);

_defineProperty(_BG, "actualCSSPalette", void 0);

_defineProperty(_BG, "actual", null);;"use strict";
...
var LoaderController = /*#__PURE__*/function () {
  ...
  _createClass(LoaderController, null, [{
    ...
    value: function init() {
      for (var a in LoaderController._loaders) {
        if (LoaderController._loaders[a] != null && !LoaderController._loaders.isBackground) {
          ...
          LoaderController._loaders[a].onProgress = LoaderController.doProgress;
    ...
    value: function doProgress() {
      ...
      if (LoaderController.onProgress) LoaderController.onProgress(LoaderController.progress);
    }
  }, {
    key: "fileLoaded",
...
_defineProperty(LoaderController, "onProgress", void 0);

class VScroll_Item {
  ...
  get progressInvertZero() { return Maths.precission(Maths.normalize(this._p1-this._scroller[this._scroller._measure], this._p0+this._scroller[this._scroller._measure], this.positionAxis),3); }
